...
\begin{table}[H]
    ...
    \begin{tabular}{l|cccc}
        ...
        \hline
        Recurrent Neural Network	& 0.67 &	0.89 &	0.86 &	\textbf{0.96} \\
        Convolutional Neural Network	& 0.78 &	0.87 &	0.83 &	0.84 \\
        Convolutional Recurrent Neural Network	& \textbf{0.81} &	\textbf{0.89} &	\textbf{0.90} &	0.93 \\
        Convolutional Transformer	& 0.77 &	0.88 &	0.88 &	0.95 \\
        Vision Transformer	& 0.54 &	0.88 &	0.88 &	\textbf{0.96} \\
