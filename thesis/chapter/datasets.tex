...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{The mapping for each of the original transcribed instruments in ENST-Drums and MDB-Drums, onto the 5-instrument vocabulary in this thesis. The description of each of the original annotated instruments can be found in their respective papers.~\cite{gillet2006enst, southall2017mdb}}
