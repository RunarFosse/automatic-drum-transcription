...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{The mapping for each of the General MIDI and Roland MIDI pitches, onto the 5-instrument vocabulary used in this thesis. MIDI pitches omitted not appearing do not have a logical 5-instrument drum mapping and are simply ignored.}
    \label{MIDIMapping}
\end{table}
...
The Slakh dataset stores its annotations in MIDI files, and thus, similarly to E-GMD, the MIDI mapping given in Table \ref{MIDIMapping} is applied to make it suitable with a 5-instrument vocabulary.
...
The SADTP dataset stores its annotations in MIDI files, and thus, similarly to E-GMD and Slakh, the MIDI mapping given in Table \ref{MIDIMapping} is applied to make it suitable with a 5-instrument vocabulary.
