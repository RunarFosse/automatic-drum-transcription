...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc}
        ...
        \hline
        ENST+MDB	& 0.81	& \cellcolor{blue!5}	& \cellcolor{blue!5} 0.53	& \cellcolor{blue!5} 0.60	& \cellcolor{blue!5} 0.42 \\
        E-GMD	& \cellcolor{blue!5}	& 	& \cellcolor{blue!5}	& \cellcolor{blue!5}	& \cellcolor{blue!5} \\
        Slakh	& \cellcolor{blue!5} 0.80	& \cellcolor{blue!5}	& 0.90	& \cellcolor{blue!5} 0.60	& \cellcolor{blue!5} 0.48 \\
        ADTOF-YT	& \cellcolor{blue!5} 0.84	& \cellcolor{blue!5}	& \cellcolor{blue!5} \underline{0.65}	& 0.93	& \cellcolor{blue!5} 0.60 \\
        \hline
        ENST+MDB + Slakh	& 0.84	& \cellcolor{blue!5}	& 0.90	& \cellcolor{blue!5} \underline{0.63}	& \cellcolor{blue!5} 0.48 \\
        ENST+MDB + ADTOF-YT	& 0.86	& \cellcolor{blue!5}	& \cellcolor{blue!5} 0.63	& 0.94	& \cellcolor{blue!5} \textbf{\underline{0.62}} \\
        Slakh + ADTOF-YT	& \cellcolor{blue!5} 0.86	& \cellcolor{blue!5}	& \textbf{0.90}	& \textbf{0.97}	& \cellcolor{blue!5} 0.62 \\
        \hline
        ENST+MDB + Slakh + ADTOF-YT	& \textbf{0.88}	& \cellcolor{blue!5}	& 0.89	& 0.95	& \cellcolor{blue!5} 0.61 \\
