...
\begin{figure}[H]
    ...
    \caption{An example of how bidirectional \glspl{RNN} allow for adjacent timesteps to influence the prediction of the current timestep. The background is a spectrogram, and the red boxes represent influence on the middle timeframe. The height of the box help visualize influence strength.}
...
\begin{figure}[H]
    ...
    \caption{An example of how \glspl{CNN} allow for a fixed context of influence, also known as its receptive field, from neighbouring timesteps when predicting each timestep. The background is a spectrogram, and the red boxes represent influence on the middle timeframe, being described by the red shaded region.}
