...
minimum height=1cm,
minimum width=4cm
] (a) {Patch Embedding: $P_i$};


\draw[arrow] (a) -- (0, -3) node[circle, 
draw, 
anchor=north,
minimum size=1em, 
inner sep=0pt
...
\draw[arrow] (h) -- (0, -5) node[rectangle,
rounded corners,
draw,
anchor=north,
minimum size=1em,
...
\draw[arrow] (v) -- (0, -6.5) node[rectangle, 
rounded corners, 
draw, 
anchor=north, 
fill=blue!20,
...
\node[anchor=north, label=below:{Output Probabilities}] at (0, -8.0){\footnotesize{($T \times 5$)}};
